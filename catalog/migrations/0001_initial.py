    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(help_text='Введите фамилию автора', max_length=100, verbose_name='Фамимлия атора')),
                ('data_of_birth', models.DateField(help_text='Введите дату рождения', null=True, verbose_name='Дата рождения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите жанр крниги', max_length=200, verbose_name='Жанр книги')),
            ],
        ),
        migrations.CreateModel(
            name='Language',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, help_text='Введите изображение обложки', null=True, upload_to='images', verbose_name='Изображение обложки')),
                ('author', models.ManyToManyField(help_text='Выберите автора(авторов)', to='catalog.author', verbose_name='Автор (авторы) книги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_nom', models.CharField(help_text='Введите инвентарный', max_length=20, null=True, verbose_name='Инвертарный номер')),
                ...
                ('status', models.ForeignKey(help_text=' Изменить состояние экземпляра', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Стаеус экземпляра книги')),
            ],
            options={
                'ordering': ['due_back'],
            },
